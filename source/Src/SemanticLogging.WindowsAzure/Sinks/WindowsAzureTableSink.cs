...
using EnterpriseLibrary.SemanticLogging.Properties;
using EnterpriseLibrary.SemanticLogging.Sinks.WindowsAzure;
using EnterpriseLibrary.SemanticLogging.Utility;
using Microsoft.WindowsAzure.Storage;
using Microsoft.WindowsAzure.Storage.RetryPolicies;
using Microsoft.WindowsAzure.Storage.Table;
using Guard = EnterpriseLibrary.SemanticLogging.Utility.Guard;
using WindowsAzureResources = EnterpriseLibrary.SemanticLogging.WindowsAzure.Properties.Resources;
