...
namespace EnterpriseLibrary.SemanticLogging.Schema
{
    /// <summary>
    ...
    public sealed class EventSchema
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseLibrary.SemanticLogging.Schema.EventSchema"/> class with the specified values.
        /// </summary>
