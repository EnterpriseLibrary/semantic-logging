...
using EnterpriseLibrary.SemanticLogging.Tests.EventListeners;
...
namespace EnterpriseLibrary.SemanticLogging.Tests.Sinks.WindowsAzureTableSinkFixture_Integration
{
